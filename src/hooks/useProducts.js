...
export const useProducts = () => {
    ...
    const fetching = async (category, page, colorFilter, shapeFilter, rewriting = false) => {
        ...
        try {
            ...
            products.value = rewriting ? response.data.glasses : [...products.value, ...response.data.glasses];
        } catch (e) {
            console.log(e)
        } finally {
